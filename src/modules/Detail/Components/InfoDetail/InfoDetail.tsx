      ...
      <div className="mt-3">
          ...
          <div className="mt-2">
            <ul className="list-disc flex flex-col gap-6">
              <li className="text-lg ">
                <span className="font-bold">chicken</span> – I used bone in skin
                on thighs because I love how much flavor you get from bone in
                chicken and I love chicken skin! You can use literally any part
                of the chicken that is your favorite. I’ve included a handy
                cooking time chart just below.
              </li>
              <li className="text-lg ">
                <span className="font-bold">chicken</span> – I used bone in skin
                on thighs because I love how much flavor you get from bone in
        ...
        <div className="bg-[#f8f8f8] my-5">
          ...
          <div className="mt-4">
            ...
            <div>
              <ul className="list-disc flex flex-col gap-6">
                <li className="mt-5 relative left-10">
            ...
            <div className="mt-5">
              <ol className="list-decimal flex flex-col gap-6">
                <li className="mt-5 px-5 relative left-5 ">
                  ...
                  Heat a skillet over medium high and add a bit of oil. When
                  hot, add the chicken, skin side down if using skin on chicken
                  and cook, until golden and cooked through, flipping as needed.
                  See chart for approximate cook times.
                </li>
                <li className="mt-5  px-5 relative left-5">
                  When the chicken is cooked through, push the chicken to one
                  side of the pan and add the garlic and cook, stirring, until
                  soft and fragrant. Stir in the honey, vinegar, and soy sauce
                  and let bubble and simmer, stirring. Coat the chicken in the
                  sauce and let it thicken slightly. Remove from the pan, being
                  sure to scoop up the extra sauce and enjoy!
                </li>
              </ol>
            </div>
          </div>
